...
const Header = () => (
    <header className="p-4 border-b border-gray-200 sticky top-0 bg-white z-10">
        <div className="container mx-auto flex justify-between items-center max-w-7xl">
            <a href="#">
                <img src="https://d35aaqx5ub95lt.cloudfront.net/images/splash/f92d5f2f7d56636846861c458c0d0b6c.svg" alt="Duolingo Logo" className="h-8" />
            </a>
    ...
    <section className="py-12 md:py-24">
        <div className="container mx-auto max-w-7xl px-4 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
                <img src="https://d35aaqx5ub95lt.cloudfront.net/images/splash/2553351646b5a3725e64177a28076645.svg" alt="Duo the owl mascot" className="w-64 mx-auto md:mx-0 mb-8" />
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    ...
                    <Button variant="white" className="w-full sm:w-auto">I already have an account</Button>
                </div>
            </div>
...
export default function App() {
    const features = [
        ...
        },
        {
            ...
            text: "We use a combination of research-backed teaching methods and delightful content to create courses that effectively teach reading, writing, listening, and speaking skills!",
